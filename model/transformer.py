...
class TransformerBlock(nn.Module):
    ...
    def __init__(self, model_dim: int, num_heads: int):
        ...
        self.attenion = self.MultiHeadedSelfAttention(model_dim, num_heads)
        self.vnn = self.VanillaNeuralNetwork(model_dim)
    ...
    def forward(self, embedded: TensorType[float]) -> TensorType[float]:
        ...
        x = embedded + self.attenion(self.ln1(embedded))
        x = x + self.vnn(self.ln2(x))
